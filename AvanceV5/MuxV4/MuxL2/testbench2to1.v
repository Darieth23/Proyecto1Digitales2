...
`include "muxEstructL2.v"
`include "cmos_cells.v"

module bancoPruebas;

    wire clk, clk_2f,clk_4f,reset_L,valid_bit0,valid_bit1,valid_bit2,valid_bit3, valid_bit_out1, valid_bit_out2, validyosys1, validyosys2;
    wire selector;
    wire [7:0] in0;
    wire [7:0] in1;
    wire [7:0] in2;
   ...
   mux2to1_L2_Estruct mux_yosys(/*AUTOINST*/
			   /*// Outputs
