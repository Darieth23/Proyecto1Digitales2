...
module demux1a2_descp_condL2(clk_4f, clk_32f, reset_L, valid, data_in0_demuxL2, validout0, validout1, dataout0_demuxL2, dataout1_demuxL2);
...
module demux1a2dosbits_descp_cond(clk_4f, clk_32f, reset_L, valid, data_in, validout0, validout1, dataout_demux1a2cuatrobits0, dataout_demux1a2cuatrobits1);
...
module demux1a2dosbits_descp_condL1(clk_2f, clk_32f, reset_L, valid, data_in, validout0, validout1, dataout_demux1a2cuatrobits0, dataout_demux1a2cuatrobits1);
...
module demux1a2ochobits_descp_cond(clk_4f, clk_32f, reset_L, valid, data_in, validout0, validout1, dataout_demux1a2dosbits0, dataout_demux1a2dosbits1);
  ...
  demux1a2dosbits_descp_cond demux1a2ochobits_dos (
    .clk_32f(clk_32f),
    .clk_4f(clk_4f),
    .data_in(data_in[7:4]),
  ...
  demux1a2dosbits_descp_cond demux1a2ochobits_uno (
    .clk_32f(clk_32f),
    .clk_4f(clk_4f),
    .data_in(data_in[3:0]),
...
module demux1a2ochobits_descp_condL1(clk_2f, clk_32f, reset_L, valid, data_in, validout0, validout1, dataout_demux1a2dosbits0, dataout_demux1a2dosbits1);
  ...
  demux1a2dosbits_descp_condL1 demux1a2ochobits_dos (
    .clk_2f(clk_2f),
    .clk_32f(clk_32f),
    .data_in(data_in[7:4]),
    .dataout_demux1a2cuatrobits0(dataout_demux1a2dosbits0[7:4]),
  ...
  demux1a2dosbits_descp_condL1 demux1a2ochobits_uno (
    .clk_2f(clk_2f),
    .clk_32f(clk_32f),
    .data_in(data_in[3:0]),
    .dataout_demux1a2cuatrobits0(dataout_demux1a2dosbits0[3:0]),
...
module demux2a4_descp_condL1(clk_2f, clk_32f, reset_L, valid1, valid2, data_in0_demuxL1, data_in1_demuxL1, validout0, validout1, validout2, validout3, dataout0_demuxL1, dataout1_demuxL1, dataout2_demuxL1, dataout3_demuxL1);
  ...
  demux1a2ochobits_descp_condL1 demux1a2_8bitdosL2 (
    .clk_2f(clk_2f),
    .clk_32f(clk_32f),
  ...
  demux1a2ochobits_descp_condL1 demux1a2_8bitunoL2 (
    .clk_2f(clk_2f),
    .clk_32f(clk_32f),
...
module partoserialrx(active, reset, clk_32f, IDL);
...
(* top =  1  *)
(* src = "phy_rx.v:7" *)
module phy_rx(clk_32f, rst, reset_L, entrada_tx, salida_rx, out0, out1, out2, out3, val_out0, val_out1, val_out2, val_out3);
  (* src = "phy_rx.v:114" *)
  wire [7:0] _000_;
  (* src = "phy_rx.v:114" *)
  wire [7:0] _001_;
...
module serialtoparrx(data_out, valid_out, clk_4f, clk_32f, reset_L, data_in);
